...
class MemoryNode(BasePlatformNode, Node):
    ...
    PARAMS = {
        ...
        "value": {"type": "string", "description": "Value to store (for set/append)"},
        "operation": {
            "type": "string",
            "enum": ["get", "set", "delete", "list", "append"],
            "default": "get",
        ...
        "persistent": {
            "type": "boolean",
            "default": False,
            "description": "Save to JSON file if true",
        },
        "namespace": {
            "type": "string",
            "description": "Optional: group keys (e.g., 'user.prefs')",
        },
    }
        ...
        if op == "get":
            ...
            if result is None:
                return {
                    "success": False,
                    "value": None,
                    "message": f"Key '{full_key}' not found",
                }
            return {
                "success": True,
                "value": result,
                "message": f"Retrieved '{full_key}'",
            }
            ...
            return {
                "success": True,
                "value": existing,
                "message": f"Appended to '{full_key}'",
            }
...
class SQLiteNode(BasePlatformNode, Node):
    ...
    PARAMS = {
        ...
        "query": {
            "type": "string",
            "description": "SQL query to execute (supports {input} and {memory_key})"
        },
        "as_list": {
            "type": "boolean",
            "default": False,
